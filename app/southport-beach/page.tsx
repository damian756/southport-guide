...
export const metadata: Metadata = {
  title: "Southport Beach | Postcode, Parking, Dogs & What to Expect | SouthportGuide",
  description:
  ...
  alternates: { canonical: `${BASE_URL}/southport-beach` },
  openGraph: {
...
const BREADCRUMB_LD = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Southport Beach", item: `${BASE_URL}/southport-beach` },
  ],
};
...
export default function SouthportBeachPage() {
  return (
    <>
      ...
      <div className="min-h-screen bg-[#FAF8F5]">
        ...
        <div className="container mx-auto px-4 py-16 max-w-7xl space-y-20">
              ...
              <div className="grid sm:grid-cols-3 gap-5">
                {[
                  ...
                  >
                    ...
                    <h3 className="font-display font-bold text-[#1B2E4B] text-lg mt-3 mb-2 group-hover:text-[#C9A84C] transition-colors"
          ...
          <section className="bg-[#1B2E4B] rounded-2xl p-8 md:p-12 text-center text-white">
            <p className="text-[#C9A84C] text-xs font-bold uppercase tracking-widest mb-3">Planning a Visit?</p>
            <h2 className="font-display text-3xl font-bold mb-4">More to Explore in Southport</h2>
            <p className="text-white/60 text-lg max-w-2xl mx-auto mb-8 leading-relaxed">
              The beach is the starting point. Southport has 22 miles of coastline, England&apos;s Golf Coast, the National Trust 
              red squirrel reserve at Formby, and a year-round events calendar. Here&apos;s the complete guide.
            </p>
