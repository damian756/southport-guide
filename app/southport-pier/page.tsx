...
export const metadata: Metadata = {
  title: "Southport Pier | England's Second Longest Pier | Complete Guide",
  description:
...
const FAQS = [
  ...
  },
  {
    ...
    a: "The postcode for the pier entrance is PR8 1QP, on the Promenade near the seafront. Park along Marine Drive (PR8 1RX) or use nearby seafront car parks and walk to the pier, it's on the Promenade, easy to find.",
  },
  {
    q: "Can you see Wales from Southport Pier?",
    a: "On a clear day, yes. From the end of the pier you can see across the Ribble Estuary and the Irish Sea. The Welsh hills. Snowdonia, are visible on exceptionally clear days, particularly in winter when visibility is best.",
  },
  {
    q: "When was Southport Pier built?",
    a: "Southport Pier opened in 1860, making it one of the oldest seaside piers in England. It has been extended, restored, and renovated several times since, including a major restoration in the early 2000s that brought it back to its current state.",
  },
  {
    q: "How long does it take to walk Southport Pier?",
    a: "About 15–20 minutes each way at a relaxed pace. The full return walk takes approximately 35–40 minutes. There is no rushing required, the views change as you walk further out, and the end of the pier has the best panoramic views over the estuary.",
  },
  {
    q: "Is Southport Pier accessible for wheelchairs?",
    a: "The pier has a flat, level surface and is generally accessible for wheelchairs and pushchairs, though the decking surface may be uneven in places. The Promenade approach to the pier is fully accessible.",
  },
  {
    q: "What is at the end of Southport Pier?",
    a: "A shelter and seating at the pierhead, along with the best views available from Southport, a 360-degree panorama across the Irish Sea estuary, the coastline north towards Blackpool, and south towards Formby. On a clear day the Welsh mountains are visible to the south-west.",
  },
];
...
const PAGE_LD = {
  ...
  name: "Southport Pier",
  description:
    "Southport Pier. 1,108 metres long, England's second longest pier. Victorian, restored, free to walk. Views over the Irish Sea estuary from the pierhead.",
  url: `${BASE_URL}/southport-pier`,
...
const BREADCRUMB_LD = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Southport Pier", item: `${BASE_URL}/southport-pier` },
  ],
};
...
export default function SouthportPierPage() {
  return (
    <>
        ...
        <div className="container mx-auto px-4 py-16 max-w-7xl space-y-20">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 md:p-12 border-l-4 border-l-[#C9A84C]">
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed text-[1.05rem]">
                <p>
                  ...
                  By the time you reach the pierhead you&apos;re over a kilometre out from the shore, with nothing but water 
                ...
                {[
                  {
                    year: "1860",
                    event: "Pier opens",
                    detail: "Original iron structure opens to the public on 2nd August. One of England's first pleasure piers.",
                  },
                  {
                    year: "1863",
                    event: "Tramway added",
                    detail: "Horse-drawn tram service introduced to carry visitors along the pier length, later converted to electric.",
                  },
                  {
                    year: "1897",
                    event: "Major extension",
                    detail: "Pier extended to its current length of 1,108 metres (3,636 feet), making it England's second longest.",
                  },
                  {
                    year: "2003",
                    event: "Restoration completed",
                    detail: "Major £7m restoration project completed, saving the pier from closure and returning it to full public use.",
                  },
                ].map((item) => (
          ...
          <section>
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
              ...
              <div className="grid sm:grid-cols-3 gap-5">
                {[
                  { name: "Southport Beach", href: "/southport-beach", detail: "One of the widest beaches in England, right alongside the pier entrance. Walk the pier, then walk the beach." },
          ...
          <section className="bg-[#1B2E4B] rounded-2xl p-8 md:p-12 text-center text-white">
            <p className="text-[#C9A84C] text-xs font-bold uppercase tracking-widest mb-3">Plan Your Visit</p>
            <h2 className="font-display text-3xl font-bold mb-4">More Southport to Explore</h2>
            <p className="text-white/60 text-lg max-w-2xl mx-auto mb-8 leading-relaxed">
              The pier is one piece of Southport&apos;s seafront offer. The beach, Marine Lake, King&apos;s Gardens, 
              and the Victorian boulevard of Lord Street are all within easy walking distance.
            </p>
            <div className="flex flex-wrap gap-4 justify-center">
              <Link href="/things-to-do" className="bg-[#C9A84C] hover:bg-[#E8C87A] text-[#1B2E4B] px-8 py-3.5 rounded-full font-bold transition-colors">
                Things to Do in Southport
              </Link>
              <Link href="/southport-beach" className="bg-white/10 border border-white/25 text-white px-8 py-3.5 rounded-full font-semibold transition-colors hover:bg-white/20">
                Southport Beach Guide →
              </Link>
            </div>
          </section>
