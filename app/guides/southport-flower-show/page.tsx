...
const FAQS = [
  { q: "When is the Southport Flower Show 2026?", a: "The Southport Flower Show 2026 is typically held in the third week of August. Exact dates for 2026 will be confirmed at southportflowershow.co.uk — check there for the official announcement. The show traditionally runs Thursday to Sunday over four days." },
  { q: "Where is the Southport Flower Show?", a: "Victoria Park, Southport. The postcode is PR8 2LG. Victoria Park is a large public park on the eastern edge of Southport town centre, about 10 minutes' walk from Lord Street." },
  { q: "How much are Southport Flower Show tickets?", a: "Ticket prices vary by day and category. Adult day tickets typically range from £18–£25, with reduced prices for seniors and concessions. Children under a certain age are often admitted free with a paying adult. Book online at southportflowershow.co.uk for the best prices — gate prices are usually higher." },
  { q: "Is there parking at the Southport Flower Show?", a: "Victoria Park itself has limited parking. Most visitors use park-and-ride services that operate during the show, or park in town centre car parks and walk (approximately 10–15 minutes). The show organisers publish a full parking and transport guide each year — check southportflowershow.co.uk nearer the date." },
  { q: "What is the best day to go to the Southport Flower Show?", a: "Thursday (opening day) is typically the least crowded. Sunday is often quieter in the afternoon when early visitors leave. Saturday is the busiest day — arrive early if attending on Saturday. Weekday tickets are usually cheaper and less crowded than the weekend." },
  { q: "What should I wear to the Southport Flower Show?", a: "The show is outdoors and covers a large site — comfortable walking shoes are essential. August in Lancashire can be warm and sunny or cool and rainy (often both on the same day). Bring layers and a light waterproof. Sun cream in warm weather. Avoid heels on the grass." },
  { q: "How do I get to the Southport Flower Show without a car?", a: "Train to Southport (Merseyrail Northern Line from Liverpool) then walk or take a short bus ride to Victoria Park — approximately 15–20 minutes on foot. Shuttle buses usually operate from the town centre. The show also publishes cycling routes from Southport station." },
  { q: "What's at the Southport Flower Show?", a: "The show combines horticultural displays, show gardens, floral art competitions, a large food and drink market, shopping exhibitors (garden tools, accessories, gifts), demonstrations, and live entertainment. The champion flower and vegetable competitions are the heart of the event — the standard is extremely high." },
];
      ...
      <div className="container mx-auto px-4 py-16 max-w-7xl space-y-20">
        ...
        <section id="what-to-see" className="scroll-mt-28">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              { emoji: "🌹", title: "Show Gardens", detail: "The centrepiece of the show. Full-scale designed gardens created specifically for the event — the same calibre of craft you&apos;d see at Chelsea or Hampton Court, in Victoria Park. The brief each year changes; some years are formal, some naturalistic, some contemporary." },
              { emoji: "🏆", title: "Competitive Classes", detail: "The heart of the show. Classes for flowers (roses, dahlias, sweet peas, chrysanthemums), vegetables (leeks, onions, potatoes, runner beans), floral art, and more. Exhibitors compete nationally. The standard is exceptional. The judging is serious. This is where the show&apos;s century of heritage lives." },
              { emoji: "🛍️", title: "Show Shopping", detail: "An enormous range of exhibitors selling tools, plants, garden accessories, gifts, and specialist items you won&apos;t find elsewhere. Much better quality than a garden centre sale. Allow a proper hour for browsing." },
              ...
              { emoji: "🎭", title: "Demonstrations", detail: "Live demonstrations from horticultural experts, chefs, and craftspeople. Cooking on the show&apos;s outdoor stage, planting and growing workshops, and specialist talks throughout the day. Check the programme when you arrive." },
              { emoji: "🎵", title: "Live Entertainment", detail: "Music and performance throughout the site. The main entertainment stage runs from mid-morning to early evening. Family-oriented entertainment in a dedicated area. The atmosphere in the afternoon on a warm day is genuinely lovely." },
            ].map((item) => (
        ...
        <section>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              { day: "Thursday", label: "Opening Day", emoji: "⭐", highlight: "Best for quiet browsing", detail: "Opening day is almost always the least crowded. Everything is fresh, exhibitors are enthusiastic, and you can take your time in the competitive classes without a crowd in the way. First-timers: go on a Thursday.", badge: "Recommended", badgeColor: "bg-green-100 text-green-800" },
              { day: "Friday", label: "Mid-Show", emoji: "🌸", highlight: "Good balance", detail: "Friday is busier than Thursday but not as hectic as the weekend. Good day for a relaxed visit. The food market is usually at its best Friday through Sunday.", badge: "Good choice", badgeColor: "bg-blue-100 text-blue-800" },
              { day: "Saturday", label: "Peak Day", emoji: "🎉", highlight: "Busiest — arrive early", detail: "The most popular day by some margin. Atmosphere is excellent, entertainment is at its best, but the site is very busy. If Saturday is your only option: arrive at opening, head to the show gardens first (crowds build from mid-morning).", badge: "Book early", badgeColor: "bg-amber-100 text-amber-800" },
              { day: "Sunday", label: "Final Day", emoji: "🌻", highlight: "Quieter in afternoon", detail: "Sunday morning can be busy, but the afternoon quietens as people drift away. Some exhibitors sell off plants and produce at reduced prices toward the end of the day. A good option if you can&apos;t make it Thursday or Friday.", badge: "Bargains later", badgeColor: "bg-purple-100 text-purple-800" },
            ].map((item) => (
        ...
        <section id="practical" className="scroll-mt-28">
          ...
          <div className="grid sm:grid-cols-2 gap-5">
            {[
              { icon: MapPin, title: "Venue", items: ["Victoria Park, Southport, PR8 2LG", "10–15 minute walk from Southport town centre", "15 minute walk from Southport railway station", "Follow show signage from town centre — well posted"] },
              { icon: Car, title: "Parking & Transport", items: ["Park-and-ride services operate during the show (check southportflowershow.co.uk for locations)", "Town centre car parks: 10–15 min walk to Victoria Park", "Train to Southport station (Merseyrail from Liverpool): 15 min walk", "Cycling: cycle parking at the show — Southport is flat"] },
              { icon: Ticket, title: "Tickets", items: ["Book online at southportflowershow.co.uk — cheaper than gate prices", "Family and group discounts available online", "Seniors and concession rates available", "Season tickets available for all four days"] },
              { icon: Clock, title: "What to Bring", items: ["Comfortable walking shoes — the site is large and mostly grass", "Light waterproof — August in Lancashire, always prepared", "Sun cream for warm days", "Cash and/or card — most exhibitors accept both", "Bags for purchases — exhibitors often don&apos;t provide them"] },
            ].map((item) => (
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              {[
                ...
                { event: "Southport Air Show", month: "September 2026", desc: "Free. 100,000+ spectators. Southport beach. One of the UK&apos;s best air shows.", href: "/guides/southport-air-show" },
