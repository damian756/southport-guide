...
export default function ComedyPubCrawlPage() {
  return (
    <GuideLayout guide={GUIDE}>
      ...
      <div className="relative min-h-[75vh] flex items-end bg-[#3D1A5C] text-white overflow-hidden">
        <div className="absolute inset-0">
          <Image src="/images/guides/comedy-pub-crawl-southport-2026.jpg" alt="Comedy Pub Crawl Southport 2026 — live comedy across multiple venues" fill sizes="100vw" quality={90} className="object-cover" priority />
          <div className="absolute inset-0 bg-gradient-to-t from-[#3D1A5C] via-[#3D1A5C]/50 to-[#3D1A5C]/10" />
        </div>
