...
const FAQS = [
  { q: "When is the Southport Air Show 2026?", a: "The Southport Air Show 2026 is typically held over a weekend in late August or early September. Exact 2026 dates will be announced at visitsouthport.com — check there for the official confirmation. The show traditionally takes place on a Saturday and Sunday." },
  { q: "Is the Southport Air Show free?", a: "Yes — the Southport Air Show is free to attend for general spectators. You watch from Southport Beach and the Promenade. There are paid grandstand packages and hospitality options for those who want a reserved viewing area, but the entire beach is free public viewing." },
  { q: "Where is the best place to watch the Southport Air Show?", a: "The airshow display line runs along the coastline parallel to the beach. Any point along the Promenade and beach gives a good view — the aircraft fly relatively close to the shore. The grandstand area near the Pier is the premium spot. To the north of the Pier is often slightly less crowded while still having excellent views." },
  ...
  { q: "What aircraft perform at the Southport Air Show?", a: "The line-up varies each year. Regular performers include the Red Arrows (when their schedule allows), Typhoon display teams, Spitfires and Hurricanes from the Battle of Britain Memorial Flight, Wildcats, and international display teams. The full programme is published on the official website ahead of the show." },
  { q: "Where should I park for the Southport Air Show?", a: "Marine Drive fills very early on airshow weekend — expect it to be full by 9am. Town centre car parks are a better bet. Park-and-ride services usually operate specifically for the airshow. Come by train if you can — it's the most reliable option. Details published by the organisers each year." },
  { q: "What time does the Southport Air Show start and finish?", a: "Flying typically starts around 10am–11am and runs until approximately 5pm each day. Exact timings for the 2026 show will be published on the official website. Arriving early gives you the best Promenade positioning and easier parking." },
  { q: "Can I bring dogs to the Southport Air Show?", a: "The airshow is on the public beach and Promenade, which are normally dog-friendly. However, the noise of jet aircraft can distress dogs. If you're bringing a dog, consider the acoustic impact and have somewhere you can move to if needed. Keep dogs on leads in crowded areas." },
];
      ...
      <div className="container mx-auto px-4 py-16 max-w-7xl space-y-20">
        ...
        <section>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              { emoji: "✈️", title: "The Flying Programme", detail: "A full day of displays running from approximately 10am to 5pm. Mix of military jets, warbirds, aerobatic teams, helicopters, and civilian display aircraft. The headline acts vary each year — confirmed when the programme is published, typically 6–8 weeks before the show." },
              { emoji: "🎺", title: "The Red Arrows", detail: "The Red Arrows perform at Southport most years — subject to their annual schedule. When they appear, the atmosphere peaks. Nine Hawks, nine smoke trails, formation flying at extraordinary precision. The beach crowd reaction is something else entirely." },
              { emoji: "⚔️", title: "Warbirds", detail: "Spitfires and Hurricanes from the Battle of Britain Memorial Flight regularly appear at Southport. The sound of a Merlin engine over the beach is the kind of thing that stays with you. Older visitors often go very quiet when the warbirds appear." },
              { emoji: "🎪", title: "Ground Events", detail: "Static aircraft displays along the Promenade, food stalls and market traders, fairground rides, and entertainment stages. The ground events are good but secondary — the flying is the show. Plan your walking to ground-level activities between flying sets." },
              { emoji: "🎖️", title: "Grandstand Packages", detail: "Paid grandstand packages are available for reserved seating in the best central viewing position. These include catering options and are limited in number. Book early — sold through the official airshow website. Worth it if you want guaranteed position for the headline acts." },
              { emoji: "🏖️", title: "The Beach Itself", detail: "The entire beach is your viewing platform and it&apos;s enormous. Even at 100,000+ attendance, the beach absorbs the crowd. You can spread out, find your own space, and watch comfortably without being crushed. The wide flat beach is a genuine advantage of this show over city-based events." },
            ].map((item) => (
        ...
        <section id="viewing" className="scroll-mt-28">
          ...
          <div className="grid sm:grid-cols-3 gap-5">
            {[
              { position: "Central (Grandstand Area)", quality: "Best", color: "bg-green-600", detail: "The paid grandstand area, centred near the Pier, is the optimal viewing position — directly in front of the main display line. If you want the best view without paying for grandstand, the public beach immediately north and south of the paid area is still excellent.", tip: "Book grandstand packages early at the official website." },
              { position: "North of the Pier", quality: "Excellent", color: "bg-blue-600", detail: "The beach north of the Pier towards the Promenade hotels is consistently slightly less crowded than the area immediately in front of the grandstand. You&apos;re still central enough for good views of the display line. Good spot if you want to spread out.", tip: "Good option for families who need space around them." },
              { position: "South (Ainsdale direction)", quality: "Good", color: "bg-amber-600", detail: "Further south along the beach the crowds thin considerably. You&apos;re slightly off-centre to the display line, but still get excellent views. The advantage: space, quieter food queues, easier access from Ainsdale station.", tip: "Train to Ainsdale station, walk north along the beach." },
            ].map((item) => (
        ...
        <section id="practical" className="scroll-mt-28">
          ...
          <div className="grid sm:grid-cols-2 gap-5">
            {[
              { icon: Car, title: "Getting There — Don't Drive", items: ["Train: Merseyrail Northern Line from Liverpool — direct to Southport, 15 min walk to the beach. Also to Birkdale or Ainsdale if you want to approach from north or south.", "Marine Drive fills by 9am on airshow weekend — don&apos;t rely on it", "Town centre car parks are your best car option (10–15 min walk to beach)", "Park-and-ride may operate specifically for the airshow — check visitsouthport.com"] },
              { icon: Clock, title: "Timing", items: ["Arrive by 9–9:30am to secure a good viewing position on the beach", "Flying typically begins 10am–11am each day", "Eat before the main lunchtime rush (before 12pm or after 2pm)", "Headline acts usually mid-afternoon — the show builds to them", "Crowd disperses quickly after the last display — leaving around 5pm is busy"] },
              { icon: MapPin, title: "What to Bring", items: ["Earplugs — essential for young children, recommended for everyone", "Folding chairs or blankets if you want to sit on the beach", "Binoculars — useful for the higher-altitude manoeuvres", "Sunscreen — you&apos;ll be on an exposed beach for hours", "Packed food — reduces queuing time significantly", "Waterproof layer — Lancashire in August, always prepared"] },
              { icon: Star, title: "Photography", items: ["A telephoto lens (200mm+) is ideal for aircraft photography", "The low angle of the beach gives dramatic sky shots", "At slower shutter speeds, propeller-driven aircraft give nice motion blur", "Overcast days often produce better aircraft photos than bright sun (no harsh shadows)", "Best shots: formation breaks, formation joins, and smoke-on passes"] },
            ].map((item) => (
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              {[
                ...
                { name: "Southport Flower Show", month: "August 2026", desc: "One of England&apos;s most prestigious horticultural shows. Victoria Park.", href: "/guides/southport-flower-show" },
