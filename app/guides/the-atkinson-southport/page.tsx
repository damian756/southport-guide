      ...
      <div className="bg-[#1B2E4B] text-white overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row md:min-h-[72vh]">
          ...
          <div className="relative min-h-[260px] sm:min-h-[360px] md:min-h-0 md:w-[44%] order-first md:order-last">
            <Image src="/images/guides/the-atkinson-southport.jpg" alt="The Atkinson Southport — gallery, theatre and café on Lord Street PR8 1DB" fill sizes="(max-width: 768px) 100vw, 44vw" className="object-contain" priority />
          </div>
          {/* Text */}
