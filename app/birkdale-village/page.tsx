...
const FAQS = [
  ...
  },
  {
    ...
    a: "Royal Birkdale Golf Club is approximately 10 minutes' walk from Birkdale Village. The club entrance is on Waterloo Road, just behind the village. During Open week, the village restaurants and cafés become the obvious pre- and post-round options for spectators.",
  },
  {
...
const BREADCRUMB_LD = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Birkdale Village", item: `${BASE_URL}/birkdale-village` },
  ],
};
...
export default function BirkdaleVillagePage() {
  return (
    <>
      ...
      <div className="min-h-screen bg-[#FAF8F5]">
        ...
        <div className="container mx-auto px-4 py-16 max-w-7xl space-y-20">
              ...
              {[
                {
                  ...
                  detail: "Independent fashion boutiques with a quality-over-quantity approach. Mix of women&apos;s fashion, accessories, and lifestyle clothing that you won&apos;t find in any department store. The buyers for these shops generally know what they&apos;re doing.",
                },
                {
                  emoji: "🏡",
                ...
                },
                {
                  emoji: "💎",
                  category: "Jewellery",
                  detail: "Independent jewellers with own-design ranges and quality vintage pieces. Better range and more interesting pieces than typical high street jewellers, at prices that are often more reasonable than you&apos;d expect.",
                },
                {
                  emoji: "🥩",
                ...
                },
                {
                  ...
                  detail: "A small but well-curated independent bookshop. The kind of place where the stock reflects genuine editorial choices rather than algorithms. Worth spending time in.",
                },
                {
                  emoji: "🌿",
                  category: "Beauty & Wellness",
                  detail: "Independent beauty and wellness shops with a focus on quality ingredients. Smaller specialist retailers that tend to be more interesting than chain equivalents. Good for gifts.",
                },
              ].map((item) => (
          ...
          <section>
            <div className="mb-8">
              ...
              <p className="text-gray-600 mt-3 max-w-2xl text-lg leading-relaxed">
                ...
                Locals rate it over the town centre for a relaxed meal. Here&apos;s the breakdown.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-r from-[#1A4020] to-[#2E6830] rounded-2xl p-8 md:p-12 text-white">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="space-y-4">
                  ...
                  <Link
                    href="/the-open-2026"
                    className="inline-flex items-center gap-2 bg-[#C9A84C] text-[#1B2E4B] px-6 py-3 rounded-full font-bold text-sm hover:bg-[#E8C87A] transition-colors mt-2"
                  >
          ...
          <section className="bg-[#1B2E4B] rounded-2xl p-8 md:p-12 text-center text-white">
            <p className="text-[#C9A84C] text-xs font-bold uppercase tracking-widest mb-3">Southport Guide</p>
            <h2 className="font-display text-3xl font-bold mb-4">More of Southport to Explore</h2>
            <p className="text-white/60 text-lg max-w-2xl mx-auto mb-8 leading-relaxed">
              Birkdale Village is a piece of what makes Southport worth exploring properly. 
              The beach, the pier, the golf, the events, and the Victorian town centre are all within easy reach.
            </p>
            <div className="flex flex-wrap gap-4 justify-center">
              ...
              <Link href="/restaurants" className="bg-white/10 border border-white/25 text-white px-8 py-3.5 rounded-full font-semibold transition-colors hover:bg-white/20">
                Restaurant Guide →
              </Link>
            </div>
          </section>
