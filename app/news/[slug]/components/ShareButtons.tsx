  ...
  return (
    <div className="mt-10 pt-6 border-t border-gray-200">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        {/* X / Twitter */}
        <a
          href={`https://twitter.com/intent/tweet?text=${encodedTitle}&url=${encodedUrl}&via=southportguide`}
          target="_blank"
          rel="noopener noreferrer"
        ...
        {/* Email */}
        <a
          href={`mailto:?subject=${encodedTitle}&body=Thought you might find this interesting: ${url}`}
