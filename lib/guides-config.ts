...
export const GUIDES: Guide[] = [
  ...
  {
    slug: "seasons-southport",
    title: "Season Coffee, Bar & Kitchen: The Full Guide",
    shortTitle: "Season Coffee",
    description: "King Street's best independent coffee shop. Micro-lot single-origin beans, a proper food menu, and Michelle's team doing it right since 2021.",
    excerpt: "Season Coffee on King Street is one of Southport's genuinely good independent cafés. Micro-lot single-origin beans, proper brunch food, a relaxed atmosphere, and everything sourced from local independents. Terry's full guide.",
    category: "food-drink",
    heroImage: "/images/guides/seasons-southport/hero.webp",
    seoPriority: 0.3,
    datePublished: "2026-05-18",
    dateUpdated: "2026-06-11",
    tags: ["cafes", "coffee", "breakfast", "brunch", "king-street", "independent"],
    status: "published",
    metaTitle: "Season Coffee Southport: Full Guide | Menu, Opening Hours & What to Order",
    metaDescription: "The full guide to Season Coffee, Bar & Kitchen on King Street, Southport. Complete menu, opening hours, what to order, and what makes it worth visiting. Terry's honest take.",
    relatedSlugs: ["best-cafes-southport", "southport-market", "lord-street"],
  },
  {
    slug: "roxy-cafe-southport",
    title: "Roxy's Cafe Southport: The Full Guide",
    shortTitle: "Roxy's Cafe",
    description: "Italian coffee shop on London Street, next to Southport train station. Julius Meinl espresso, freshly baked croissants, homemade cakes and the famous pistachio coffee.",
    excerpt: "Roxy's Cafe on London Street is Southport's Italian coffee shop. Julius Meinl beans, freshly baked pistachio croissants, homemade cakes and a coffee and cake deal for £7.50. Right next to the train station. Open from 8am Monday to Friday. Terry's full guide.",
    category: "food-drink",
    heroImage: "/images/guides/roxy-cafe-southport/hero.jpg",
    seoPriority: 0.88,
    datePublished: "2026-06-11",
    dateUpdated: "2026-06-11",
    tags: ["cafes", "coffee", "italian", "london-street", "independent", "train-station"],
    status: "published",
    metaTitle: "Roxy's Cafe Southport | Italian Coffee, Croissants and Cakes on London Street",
    metaDescription: "Roxy's Cafe on London Street, Southport. Julius Meinl Italian coffee, freshly baked pistachio croissants, homemade cakes and coffee and cake for £7.50. Right next to Southport train station. Open from 8am.",
    relatedSlugs: ["best-cafes-southport", "southport-market"],
  },
  {
